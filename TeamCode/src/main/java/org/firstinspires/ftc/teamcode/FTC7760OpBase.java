...
public abstract class FTC7760OpBase extends LinearOpMode {
    ...
    public final int armMaxLocation = 2600;

    // Base speed of arm movement
    public final int armIncrement =10; // TODO: tune or new arm motor speed!!

    // Arm presets
    public final int highPosition = 1920;
    public final int middlePosition = 2250;
    public final int lowPosition = 2500;
    public final int safePosition = 1400;
    public final int drivePosition = 250;
    ...
    public void armPresetHigh() {
        setArmPosition(highPosition);
    }

    public void armPresetMiddle() {
        setArmPosition(middlePosition);
    }

    public void armPresetLow() {
        setArmPosition(lowPosition);
    }
