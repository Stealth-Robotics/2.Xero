...
public class RedNearAuto extends StealthOpMode {
    ...
    public void initialize() {
        ...
        camera = new CameraSubsystem(hardwareMap, Alliance.RED, telemetry);
        ...
        toPropRight = drive.trajectoryBuilder(startPose)
                .splineToSplineHeading(new Pose2d(17,-47,Math.toRadians(40)),Math.toRadians(0))
                .build();
        toPropLeft = drive.trajectoryBuilder(startPose)
                .splineToSplineHeading(new Pose2d(19,-56,Math.toRadians(105)),Math.toRadians(0))
                .build();
    }
    ...
    public Command getAutoCommand() {
        ...
        }  else if (propPosition == PropProcessor.PropPosition.RIGHT) {
            return new SequentialCommandGroup(
                    new InstantCommand(()->drive.setPoseEstimate(startPose)),
                    new InstantCommand(() -> wrist.wristRotate(XeroConstants.WristSafePosition), wrist),
                    new InstantCommand(() -> arm.setRunPID(true)),
